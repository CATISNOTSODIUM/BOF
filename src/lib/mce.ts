...
import { Result, unwrap, ok, is_error, error, Env } from "./types";

export function ParseAndEvaluate(source: string, mem_return = false): Result<Number[] | [Number[], Number[], Env, any], string> {
